    ...
    /***/ 239: /***/ (__unused_webpack_module, exports) => {
      ...
      class ControlsHook extends $e.modules.hookUI.After {
        ...
        getId() {
          ...
          return "everest-elementor-editor-controls-handler";
        }

        /**
         * Get everest Elementor Theme Controls
         *
         ...
         *   {
         *      everest_elementor_show_logo: '.site-header .site-header-logo',
         *      everest_elementor_show_menu: '.site-header .site-header-menu',
         *   }
         */
        geteverestThemeControls() {
          return {
            everest_header_logo_display: {
              ...
              callback: ($element, args) => {
                this.toggleShowHideClass(
                  $element,
                  args.settings.everest_header_logo_display
                );
              },
            },
            everest_header_menu_display: {
              ...
              callback: ($element, args) => {
                this.toggleShowHideClass(
                  $element,
                  args.settings.everest_header_menu_display
                );
              },
            },
            everest_header_tagline_display: {
              ...
              callback: ($element, args) => {
                this.toggleShowHideClass(
                  $element,
                  args.settings.everest_header_tagline_display
                );
              },
            },
            everest_header_logo_type: {
              ...
              callback: ($element, args) => {
                const classPrefix = "show-",
                  inputOptions =
                    args.container.controls.everest_header_logo_type.options,
                  inputValue = args.settings.everest_header_logo_type;
            ...
            everest_header_layout: {
              ...
              callback: ($element, args) => {
                const classPrefix = "header-",
                  inputOptions =
                    args.container.controls.everest_header_layout.options,
                  inputValue = args.settings.everest_header_layout;
                this.toggleLayoutClass(
                  $element,
                  classPrefix,
                  inputOptions,
            ...
            everest_header_width: {
              ...
              callback: ($element, args) => {
                const classPrefix = "header-",
                  inputOptions =
                    args.container.controls.everest_header_width.options,
                  inputValue = args.settings.everest_header_width;
                this.toggleLayoutClass(
                  $element,
                  classPrefix,
                  inputOptions,
            ...
            everest_header_menu_layout: {
              ...
              callback: ($element, args) => {
                const classPrefix = "menu-layout-",
                  inputOptions =
                    args.container.controls.everest_header_menu_layout.options,
                  inputValue = args.settings.everest_header_menu_layout;
            ...
            everest_header_menu_dropdown: {
              ...
              callback: ($element, args) => {
                const classPrefix = "menu-dropdown-",
                  inputOptions =
                    args.container.controls.everest_header_menu_dropdown
                      .options,
                  inputValue = args.settings.everest_header_menu_dropdown;
                this.toggleLayoutClass(
                  $element,
                  classPrefix,
                  inputOptions,
            ...
            everest_footer_logo_display: {
              ...
              callback: ($element, args) => {
                this.toggleShowHideClass(
                  $element,
                  args.settings.everest_footer_logo_display
                );
              },
            },
            everest_footer_tagline_display: {
              ...
              callback: ($element, args) => {
                this.toggleShowHideClass(
                  $element,
                  args.settings.everest_footer_tagline_display
                );
              },
            },
            everest_footer_menu_display: {
              ...
              callback: ($element, args) => {
                this.toggleShowHideClass(
                  $element,
                  args.settings.everest_footer_menu_display
                );
              },
            },
            everest_footer_copyright_display: {
              ...
              callback: ($element, args) => {
                const $footerContainer = $element.closest("#site-footer"),
                  inputValue = args.settings.everest_footer_copyright_display;
            ...
            everest_footer_logo_type: {
              ...
              callback: ($element, args) => {
                const classPrefix = "show-",
                  inputOptions =
                    args.container.controls.everest_footer_logo_type.options,
                  inputValue = args.settings.everest_footer_logo_type;
                this.toggleLayoutClass(
                  $element,
                  classPrefix,
                  inputOptions,
            ...
            everest_footer_layout: {
              ...
              callback: ($element, args) => {
                const classPrefix = "footer-",
                  inputOptions =
                    args.container.controls.everest_footer_layout.options,
                  inputValue = args.settings.everest_footer_layout;
                this.toggleLayoutClass(
                  $element,
                  classPrefix,
                  inputOptions,
            ...
            everest_footer_width: {
              ...
              callback: ($element, args) => {
                const classPrefix = "footer-",
                  inputOptions =
                    args.container.controls.everest_footer_width.options,
                  inputValue = args.settings.everest_footer_width;
                this.toggleLayoutClass(
                  $element,
                  classPrefix,
                  inputOptions,
            ...
            everest_footer_copyright_text: {
              selector: ".site-footer .copyright",
              callback: ($element, args) => {
                const inputValue = args.settings.everest_footer_copyright_text;
        ...
        getConditions(args) {
          ...
          return !!Object.keys(this.geteverestThemeControls()).includes(
            changedControls[0]
          );
        }
         ...
         */
        apply(args) {
          const allThemeControls = this.geteverestThemeControls(),
