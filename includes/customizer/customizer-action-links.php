<?php
namespace EverestTheme\Includes\Customizer;

if ( ! defined( 'ABSPATH' ) ) {
	exit; // Exit if accessed directly.
}

class everest_Customizer_Action_Links extends \WP_Customize_Control {
		...
		switch ( $action_link_type ) {
			case 'install-elementor':
				$action_link_data = [
					...
					'alt' => esc_attr__( 'Elementor', 'everest-elementor' ),
					'title' => esc_html__( 'Install Elementor', 'everest-elementor' ),
					'message' => esc_html__( 'Create cross-site header & footer using Elementor.', 'everest-elementor' ),
					'button' => esc_html__( 'Install Elementor', 'everest-elementor' ),
					'link' => wp_nonce_url(
						add_query_arg(
							[
			...
			case 'activate-elementor':
				$action_link_data = [
					'image' => get_template_directory_uri() . '/assets/images/elementor.svg',
					'alt' => esc_attr__( 'Elementor', 'everest-elementor' ),
					'title' => esc_html__( 'Activate Elementor', 'everest-elementor' ),
					'message' => esc_html__( 'Create cross-site header & footer using Elementor.', 'everest-elementor' ),
					'button' => esc_html__( 'Activate Elementor', 'everest-elementor' ),
			...
			case 'activate-header-footer-experiment':
				$action_link_data = [
					'image' => get_template_directory_uri() . '/assets/images/elementor.svg',
					'alt' => esc_attr__( 'Elementor', 'everest-elementor' ),
					'title' => esc_html__( 'Style using Elementor', 'everest-elementor' ),
					'message' => esc_html__( 'Design your cross-site header & footer from Elementor’s "Site Settings" panel.', 'everest-elementor' ),
					'button' => esc_html__( 'Activate header & footer experiment', 'everest-elementor' ),
			...
			case 'style-header-footer':
				$action_link_data = [
					'image' => get_template_directory_uri() . '/assets/images/elementor.svg',
					'alt' => esc_attr__( 'Elementor', 'everest-elementor' ),
					'title' => esc_html__( 'Style cross-site header & footer', 'everest-elementor' ),
					'message' => esc_html__( 'Customize your cross-site header & footer from Elementor’s "Site Settings" panel.', 'everest-elementor' ),
					'button' => esc_html__( 'Start Designing', 'everest-elementor' ),
	...
	private function get_customizer_action_links_html( $data ) {
		...
		return sprintf(
			'<div class="everest-action-links">
				<img src="%1$s" alt="%2$s">
				<p class="everest-action-links-title">%3$s</p>
				<p class="everest-action-links-message">%4$s</p>
